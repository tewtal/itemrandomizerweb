...
module HardLocations =
    ...
    let canAccessHeatedNorfair items =
        canAccessRedTower items &&
            (((canFly items || haveItem items HiJump) && (canHellRun items)) ||
             energyReserveCount items >= 10 ||
             (haveItem items SpeedBooster &&
              (haveItem items Ice || canUsePowerBombs items) &&
              canHellRun items))
    ...
    let canAccessLowerNorfair items = 
        canAccessHeatedNorfair items &&
        canUsePowerBombs items &&
        (haveItem items Varia || (energyReserveCount items >= 10 && canCrystalFlash items))
    ...
    let canDefeatBotwoon items = 
        ...
        (haveItem items Ice || (haveItem items SpeedBooster && haveItem items Gravity))

    let canDefeatDraygon items = 
        canDefeatBotwoon items &&
            (haveItem items Gravity || canCrystalFlash items || (haveItem items XRay && (haveItem items SpringBall || haveItem items XRay)))
    ...
    let AllLocations = 
        [
            ...
            };
            {
                ...
                Available = fun items ->canAccessRedBrinstar items && 
                                        ...
                                        (haveItem items Grapple ||
                                         ...
                                         (haveItem items Gravity && energyReserveCount items >= 1) ||
            ...
            };
            {
                ...
                Address = 0x7896E;
                Visibility = Chozo;
                Available = fun items -> canAccessRedTower items && canPassBombPassages items;
            };
            {
                Area = Brinstar;
            ...
            };
            {
                ...
                Address = 0x78BAC;
                Visibility = Chozo;
                Available = fun items -> canAccessRedTower items;
            };
            {
                Area = Norfair;
            ...
            };
            {
                ...
                Address = 0x78C36;
                Visibility = Chozo;
                Available = fun items -> canAccessCrocomire items && haveItem items Morph &&
                                            (canFly items ||
                                             haveItem items Ice ||
                                             haveItem items SpeedBooster);
            };
