...
module OpenLocations =
    ...
    let canAccessCrocomire items =
        (canAccessHeatedNorfair items && haveItem items Morph) ||
        (haveItem items SpeedBooster && canHellRun items)
    ...
    let canAccessOuterMaridia items = 
        (haveItem items Gravity ||
         (haveItem items HiJump && (haveItem items Ice || (haveItem items Morph && haveItem items SpringBall))))
    
    let canAccessInnerMaridia items = 
        (haveItem items Gravity ||
         (haveItem items HiJump && (haveItem items Ice || (haveItem items Morph && haveItem items SpringBall)) && haveItem items Grapple))
    
    let canDefeatBotwoon items = 
        canAccessInnerMaridia items &&
        (haveItem items Ice || haveItem items SpeedBooster) &&
        ((haveItem items SpeedBooster && haveItem items Gravity) || haveItem items Morph)

    let canDefeatDraygon items = 
        canDefeatBotwoon items &&        
        (haveItem items Morph || (haveItem items SpeedBooster && haveItem items Gravity)) &&
            (haveItem items Gravity ||
    ...
    let AllLocations = 
        [
            ...
            };
            {
                ...
                Address = 0x781E8;
                Visibility = Visible;
                Available = fun items -> canMorph items;
            };
            {
                Area = Crateria;
            ...
            };
            {
                ...
                Address = 0x781F4;
                Visibility = Visible;
                Available = fun items -> canMorph items && canOpenGreenDoors items;
            };
            {
                Area = Crateria;
            ...
            };
            {
                ...
                Class = Major;
                Visibility = Chozo;
                Available = fun items -> canOpenRedDoors items;
            };
            {
                Area = Crateria;
            ...
            };
            {
                ...
                Address = 0x7851E;
                Visibility = Visible;
                Available = fun items -> canOpenRedDoors items && (canMorph items || haveItem items SpeedBooster)
            };
            {
                Area = Brinstar;
            ...
            };
            {
                ...
                Address = 0x78824;
                Visibility = Visible;
                Available = fun items -> (haveItem items Wave || haveItem items Super);
            };
            {
                Area = Brinstar;
            ...
            };
            {
                ...
                Available = fun items -> canUsePowerBombs items &&
                                          (haveItem items Grapple ||
                                           ...
                                           (haveItem items Varia && energyReserveCount items >= 3) ||
            ...
            };
            {
                ...
                Address = 0x7890E;
                Visibility = Chozo;
                Available = fun items -> canOpenGreenDoors items;
            };
            {
                Area = Brinstar;
                ...
                Address = 0x78914;
                Visibility = Visible;
                Available = fun items -> canOpenGreenDoors items && canUsePowerBombs items;
            };
            {
                Area = Brinstar;
                Name = "Spazer";
            ...
            };
            {
                ...
                Available = fun items -> canAccessCrocomire items &&
                                         canOpenGreenDoors items &&                
                                          (haveItem items Gravity || canFly items || (haveItem items HiJump && (haveItem items Ice || haveItem items SpeedBooster)))
            };
            {
                Area = Norfair;
            ...
            };
            {
                ...
                Address = 0x78C52;
                Visibility = Visible;
                Available = fun items -> canOpenGreenDoors items && canAccessHeatedNorfair items;
            };
            {
                Area = Norfair;
            ...
            };
            {
                ...
                Address = 0x78F30;
                Visibility = Visible;
                Available = fun items -> canPassWorstRoom items && canMorph items;
            };
            {
                Area = LowerNorfair;
            ...
            };
            {
                ...
                Address = 0x78FD2;
                Visibility = Visible;
                Available = fun items -> canPassWorstRoom items && canPassBombPassages items;
            };
            {
                Area = LowerNorfair;
            ...
            };
            {
                ...
                Address = 0x7C2E9;
                Visibility = Chozo;
                Available = fun items -> haveItem items SpeedBooster &&
                                         canUsePowerBombs items &&
            ...
            };
            {
                ...
                Address = 0x7C36D;
                Visibility = Chozo;
                Available = fun items -> (haveItem items Varia || energyReserveCount items >= 1)
                                         && canMorph items;
            };
            {
                Area = Maridia;
                ...
                Address = 0x7C437;
                Visibility = Visible;
                Available = fun items -> haveItem items Gravity &&
                                         haveItem items SpeedBooster;
            };
            {
                Area = Maridia;
                ...
                Available = fun items -> canAccessOuterMaridia items &&
                                         canMorph items &&
                                         (haveItem items SpringBall || canPassBombPassages items);
            };
            {
                Area = Maridia;
                ...
                Available = fun items -> canAccessOuterMaridia items &&
                                            (canFly items ||
                                             (haveItem items SpeedBooster && haveItem items Gravity) ||
                                             haveItem items Grapple);
            };
            {
                Area = Maridia;
            ...
            };
            {
                ...
                Address = 0x7C4AF;
                Visibility = Visible;
                Available = fun items -> canMorph items && canAccessInnerMaridia items;
            };
            {
                Area = Maridia;
